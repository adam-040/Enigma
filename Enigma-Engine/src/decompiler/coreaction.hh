...
public:
  ActionSegmentize(const string &g) : Action(0,"segmentize",g) { localcount = 0; }	///< Constructor
...
public:
  ActionConstantPtr(const string &g) : Action(0,"constantptr",g) { localcount = 0; }	///< Constructor
  virtual void reset(Funcdata &data) { localcount = 0; }
  virtual Action *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Action *)0;
...
public:
  ActionInferTypes(const string &g) : Action(0,"infertypes",g) { localcount = 0; }	///< Constructor
  virtual void reset(Funcdata &data) { localcount = 0; }
  virtual Action *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Action *)0;
