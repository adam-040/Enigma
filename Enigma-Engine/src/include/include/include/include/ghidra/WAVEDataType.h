...
class WAVEDataType : public BuiltIn, public virtual Dynamic {
public:
    WAVEDataType();
    explicit WAVEDataType(DataTypeManager* dtm);
    ...
    std::string getDefaultLabelPrefix() const override { return "WAVE"; }
