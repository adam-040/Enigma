...
class GifDataType : public BuiltIn, public virtual Dynamic {
public:
    GifDataType();
    explicit GifDataType(DataTypeManager* dtm);
    ...
    std::string getDefaultLabelPrefix() const override { return "GIF"; }
