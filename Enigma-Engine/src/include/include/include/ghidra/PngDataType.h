...
class PngDataType : public BuiltIn, public virtual Dynamic {
public:
    PngDataType();
    explicit PngDataType(DataTypeManager* dtm);
    ...
    std::string getDefaultLabelPrefix() const override { return "PNG"; }
