...
class MIDIDataType : public BuiltIn, public virtual Dynamic {
public:
    MIDIDataType();
    explicit MIDIDataType(DataTypeManager* dtm);
    ...
    std::string getDefaultLabelPrefix() const override { return "MIDI"; }
