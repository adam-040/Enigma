 ...
 */
/// \file OffsetShiftSettingsDefinition.h
/// \brief Settings definition for bit-shift applied to pointer offset
/// Translated from: ghidra.program.model.data.OffsetShiftSettingsDefinition
#pragma once
...
class OffsetShiftSettingsDefinition : public NumberSettingsDefinition, public TypeDefSettingsDefinition {
private:
    OffsetShiftSettingsDefinition() = default;

public:
    static OffsetShiftSettingsDefinition& def();
