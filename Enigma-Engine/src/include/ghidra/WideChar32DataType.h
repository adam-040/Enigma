 ...
 */
/// \file WideChar32DataType.h
/// \brief Wide-Character (32-bit/UTF32) data type.
/// Translated from: ghidra.program.model.data.WideChar32DataType
#pragma once
...
/**
 * Wide-Character (32-bit/UTF32) data type.
 *
 * Translated from: ghidra.program.model.data.WideChar32DataType
 */
class WideChar32DataType : public BuiltIn {
public:
    static WideChar32DataType& dataType();

    WideChar32DataType(DataTypeManager* dtm = nullptr);
