uint2 __stdcall entry(uint64_t param_1,uint64_t param_2)
{
  ...
  return (uint2)(SUB161(v_2 >> 7,0) & 1) | (uint2)(SUB161(v_2 >> 0xf,0) & 1) << 1 |
         (uint2)(SUB161(v_2 >> 0x17,0) & 1) << 2 | (uint2)(SUB161(v_2 >> 0x1f,0) & 1) << 3 |
         (uint2)(SUB161(v_2 >> 0x27,0) & 1) << 4 | (uint2)(SUB161(v_2 >> 0x2f,0) & 1) << 5 |
         (uint2)(SUB161(v_2 >> 0x37,0) & 1) << 6 | (uint2)(SUB161(v_2 >> 0x3f,0) & 1) << 7 |
         (uint2)(SUB161(v_2 >> 0x47,0) & 1) << 8 | (uint2)(SUB161(v_2 >> 0x4f,0) & 1) << 9 |
         (uint2)(SUB161(v_2 >> 0x57,0) & 1) << 10 | (uint2)(SUB161(v_2 >> 0x5f,0) & 1) << 0xb |
         (uint2)((uint1)(v_6 >> 7) & 1) << 0xc | (uint2)((uint1)(v_6 >> 0xf) & 1) << 0xd |
         (uint2)((uint1)(v_6 >> 0x17) & 1) << 0xe | (uint2)(uint1)(v_2[0xf] >> 7) << 0xf;
}
