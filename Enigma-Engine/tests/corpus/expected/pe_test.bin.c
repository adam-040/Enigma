...
void __fastcall
func_0x1400b8cd0(uint64_t param_1,uint64_t param_2,uint64_t param_3,uint64_t param_4)
{
  uint64_t v_1;
  uint4 v_2;
  int4 v_3;
...
code_0x1400b8e07:
      ...
      if (v_10 < 0x21) {
        if (v_10 == 8) {
          ...
          v_7 = (v_6 - (int8)v_14) + v_7;
          local_0x50[0] = v_7;
          if (((v_2 & 0xc0) == 0) && ((0xff < v_7 || (v_7 < -0x80)))) goto code_0x1400b903f;
          ...
          *(uint64_t *)((int8)local_0xb8 + v_5 + 0x28) = 0x1400b9012;
          ...
          v_7 = (v_6 - (int8)v_14) + v_7;
          local_0x50[0] = v_7;
          if (((v_2 & 0xc0) == 0) && ((0xffff < v_7 || (v_7 < -0x8000)))) goto code_0x1400b903f;
