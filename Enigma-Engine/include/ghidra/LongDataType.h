 ...
 */
/// \file LongDataType.h
/// \brief Basic implementation for a Signed Long Integer dataType
#pragma once
 ...
 * Translated from: ghidra.program.model.data.LongDataType
 */
class LongDataType : public AbstractSignedIntegerDataType {
public:
    static LongDataType& dataType();

    explicit LongDataType(DataTypeManager* dtm = nullptr);
