...
class AIFFDataType : public BuiltIn, public virtual Dynamic {
public:
    AIFFDataType();
    explicit AIFFDataType(DataTypeManager* dtm);
    ...
    std::string getDefaultLabelPrefix() const override { return "AIFF"; }
