...
class SignedWordDataType : public AbstractSignedIntegerDataType {
public:
    static SignedWordDataType& dataType();

    explicit SignedWordDataType(DataTypeManager* dtm = nullptr);
