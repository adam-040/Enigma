...
class JPEGDataType : public BuiltIn, public virtual Dynamic {
public:
    JPEGDataType();
    explicit JPEGDataType(DataTypeManager* dtm);
    ...
    std::string getDefaultLabelPrefix() const override { return "JPEG"; }
