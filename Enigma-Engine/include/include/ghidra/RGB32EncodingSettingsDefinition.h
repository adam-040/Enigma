 ...
 */
/// \file RGB32EncodingSettingsDefinition.h
/// \brief Typedef settings definition which specifies a 32-bit RGB Color Encoding
/// Translated from: ghidra.program.model.data.RGB32EncodingSettingsDefinition
#pragma once
 ...
 */
class RGB32EncodingSettingsDefinition : public EnumSettingsDefinition, public TypeDefSettingsDefinition {
public:
    enum class RGB32Encoding {
        ARGB_8888,
        RGBA_8888,
        BGRA_8888,
        ABGR_8888
    ...
    static const RGB32Encoding DEFAULT_ENCODING = RGB32Encoding::ARGB_8888;

private:
    RGB32EncodingSettingsDefinition() = default;

public:
    static RGB32EncodingSettingsDefinition& def();

    /// Returns the RGB encoding standard based on the specified settings
    RGB32Encoding getRGBEncoding(const Settings* settings) const;

    void setRGBEncoding(Settings* settings, RGB32Encoding encoding);
