...
/**
 * CodeBlockReference defines an interface for a reference between code blocks.
 * Translated from: ghidra.program.model.block.CodeBlockReference
 */
...
public:
    ...
    virtual const RefType* getFlowType() const = 0;
